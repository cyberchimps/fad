...
if ( ! function_exists( 'fad_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function fad_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'fad' ),
...
if ( ! function_exists( 'fad_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function fad_entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'fad' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'fad_post_thumbnail' ) ) :
	/**
